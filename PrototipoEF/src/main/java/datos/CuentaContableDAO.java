...
public class CuentaContableDAO {
    ...
    public String getMontoAnterior(String codigoCuenta) {
        ...
        try {
            con = Conexion.getConnection();
            stmt = con.prepareStatement("SELECT cuentacontable.Monto_CuentaContable FROM tbl_cuentacontable WHERE cuentacontable.Codigo_CuentaContable = ?");
    ...
    public int setMontoNuevo(String codigoCuenta, String monto) {
        ...
        try {
            con = Conexion.getConnection();
            stmt = con.prepareStatement("UPDATE cuentacontable SET cuentacontbale.Monto_CuentaContable = ? FROM tbl_cuentacontable WHERE cuentacontable.Codigo_CuentaContable = ?");
            stmt.setString(1, codigoCuenta);
